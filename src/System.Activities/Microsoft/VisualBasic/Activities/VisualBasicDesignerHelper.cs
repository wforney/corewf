...
namespace Microsoft.VisualBasic.Activities
{
    ...
    public static class VisualBasicDesignerHelper
    {
        ...
        private static VisualBasicNameShadowingConstraint nameShadowingConstraint = new VisualBasicNameShadowingConstraint();
        ...
        {
            var textExpression = visualBasicValue as ITextExpression;
            ...
            var environment = visualBasicValue.GetParentEnvironment();
        ...
        public static Activity RecompileVisualBasicReference(ActivityWithResult visualBasicReference,
            ...
            out VisualBasicSettings vbSettings)
        {
            var textExpression = visualBasicReference as ITextExpression;
            if (textExpression == null || textExpression.Language != VisualBasicHelper.Language)
            {
            ...
            var expressionText = textExpression.ExpressionText;
            var environment = visualBasicReference.GetParentEnvironment();
        ...
        private static void GetAllImportReferences(Activity activity, out IList<string> namespaces, out IList<string> assemblies)
        {
        ...
        private class VisualBasicExpressionFactory<T> : VisualBasicExpressionFactory
        {
