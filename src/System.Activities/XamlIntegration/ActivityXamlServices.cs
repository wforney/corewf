...
namespace System.Activities.XamlIntegration
{
    ...
    public static class ActivityXamlServices
    {
        ...
        private static void Compile(IDynamicActivity dynamicActivity, LocationReferenceEnvironment environment)
        {
            ...
            {
                var compiler = new TextExpressionCompiler(GetCompilerSettings(dynamicActivity, language));
                ...
                if (results.HasErrors)
                {
                    ...
                    var exception = new InvalidOperationException(SR.ActivityXamlServicesCompilationFailed(messages.ToString()));
                ...
                var compiledExpressionRoot = Activator.CreateInstance(compiledExpressionRootType, new object[] { dynamicActivity }) as ICompiledExpressionRoot;
        ...
        private static XamlSchemaContext GetXamlSchemaContext(Assembly assembly, string helperClassName)
        {
            ...
            var reflectionPerm = new ReflectionPermission(ReflectionPermissionFlag.MemberAccess);
            ...
            try
            {
                ...
                // The "official" BeforeInitializeComponent XBT Extension will not create a generic
                // type for this helper class. This check is here so that the assembly manifest
                // can't lure us into creating a type with a generic argument from a different assembly.
