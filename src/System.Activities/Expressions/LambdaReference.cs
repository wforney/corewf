...
namespace System.Activities.Expressions
{
    ...
    public sealed class LambdaReference<T> : CodeActivity<Location<T>>, IExpressionContainer, IValueSerializableExpression
    {
        ...
        {
            // This workflow contains lambda expressions specified in code. These expressions are
            // not XAML serializable. In order to make your workflow XAML-serializable, use either
            // VisualBasicValue/Reference or ExpressionServices.Convert This will convert your
            // lambda expressions into expression activities.
