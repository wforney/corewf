...
namespace System.Activities
{
    ...
    public abstract class AsyncCodeActivity : Activity, IAsyncCodeActivity
    {
        ...
        internal static void CompleteAsynchronousExecution(IAsyncResult result)
        {
            ...
            // User code may not have correctly passed the AsyncOperationContext thru as the "state"
            // parameter for BeginInvoke. If is null, don't bother going any further. We would have
            // thrown an exception out of the workflow from InternalExecute. In that case,
            // AsyncOperationContext.CancelOperation will be called in InternalExecute.
