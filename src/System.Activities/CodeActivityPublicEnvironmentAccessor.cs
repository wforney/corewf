...
namespace System.Activities
{
    ...
    public struct CodeActivityPublicEnvironmentAccessor
    {
        ...
        public static CodeActivityPublicEnvironmentAccessor Create(CodeActivityMetadata metadata)
        {
            ...
            var result = new CodeActivityPublicEnvironmentAccessor
            {
                metadata = metadata
            };
            return result;
        ...
        public override bool Equals(object obj)
        {
            ...
            var other = (CodeActivityPublicEnvironmentAccessor)obj;
        ...
        {
            var expression = ActivityUtilities.CreateLocationAccessExpression(sourceReference, true, useLocationReferenceValue);
        ...
        {
            var argument = ActivityUtilities.CreateArgument(argumentType, direction);
            argument.Expression = expression;
            var runtimeArgument = this.metadata.CurrentActivity.AddTempAutoGeneratedArgument(argumentType, direction);
