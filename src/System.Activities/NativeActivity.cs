...
namespace System.Activities
{
    ...
    public abstract class NativeActivity : Activity, IInstanceUpdatable
    {
        ...
        {
            // note that this may be called multiple times on this same activity but with different
            // instances Override this only if you need to update runtime state as part of a dynamic update.
        }
    }
