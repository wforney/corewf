...
using System.Activities.DynamicUpdate;
    ...
    internal sealed class InternalState : NativeActivity<string>
    {
        ...
        private readonly Collection<InternalTransition> internalTransitions;

        // number of running triggers
        private readonly Variable<int> currentRunningTriggers;
        private readonly Variable<bool> isExiting;

        // This bookmark is used to evaluate condition of a transition of this state. 
        private readonly Variable<Bookmark> evaluateConditionBookmark;

        // Callback which is called when Entry is completed.
        private readonly CompletionCallback onEntryComplete;

        // Callback which is called when Trigger is completed.
        private readonly CompletionCallback onTriggerComplete;

        // Callback which is called when Condition is completed.
        private readonly CompletionCallback<bool> onConditionComplete;

        // Callback which is called when Exit is completed.
        private readonly CompletionCallback onExitComplete;

        // Callback which is used to start to evaluate Condition of a transition of this state.
        private readonly BookmarkCallback evaluateConditionCallback;
        private readonly Dictionary<Activity, InternalTransition> triggerInternalTransitionMapping = new Dictionary<Activity, InternalTransition>();
        ...
        private void OnExitComplete(NativeActivityContext context, ActivityInstance instance)
        {
