...
namespace System.Activities
{
    ...
    public abstract partial class Activity
    {
        ...
        /// </summary>
        /// <value><c>true</c> if this instance has been associated with an instance; otherwise, <c>false</c>.</value>
        ...
        /// <returns><c>true</c> if [is result argument] [the specified argument]; otherwise, <c>false</c>.</returns>
        ...
        internal void SetImplementationVariablesCollection(Collection<Variable> implementationVariables) => this.ImplementationVariables = implementationVariables;
        ...
        /// <returns><c>true</c> if [is singleton activity declared] [the specified name]; otherwise, <c>false</c>.</returns>
        ...
        /// Sets the cached.
        /// </summary>
        /// <param name="isSkippingPrivateChildren">if set to <c>true</c> [is skipping private children].</param>
    ...
    /// <summary>
    /// The Activity class.
    /// Implements the <see cref="System.Activities.ActivityWithResult" />
    /// </summary>
    ...
    public abstract class Activity<TResult> : ActivityWithResult
    {
        ...
        /// <summary>
        /// Performs an implicit conversion from <see cref="TResult" /> to <see cref="Activity{TResult}" />.
        /// </summary>
        ...
        /// <summary>
        /// Performs an implicit conversion from <see cref="Variable" /> to <see cref="Activity{TResult}" />.
        /// </summary>
        /// <param name="variable">The variable.</param>
        /// <returns>The result of the conversion.</returns>
        ...
        /// <summary>
        /// Performs an implicit conversion from <see cref="Variable{TResult}" /> to <see cref="Activity{TResult}" />.
        /// </summary>
        /// <param name="variable">The variable.</param>
        /// <returns>The result of the conversion.</returns>
        ...
        /// <param name="argument">The argument.</param>
        /// <param name="createEmptyBindings">if set to <c>true</c> [create empty bindings].</param>
        /// <returns><c>true</c> if [is bound argument correct] [the specified argument]; otherwise, <c>false</c>.</returns>
