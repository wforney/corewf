...
namespace System.Activities.XamlIntegration
{
    ...
    internal class ActivityBuilderXamlWriter : XamlWriter
    {
        ...
        private XamlMember activityBuilderPropertyReferences;
        ...
        private class RootNode : BuilderXamlNode
        {
            ...
            private HashSet<string> rootLevelPrefixes;
        ...
        {
            private readonly BuilderClassNode classNode;
            private string builderName;
            private readonly XamlNodeQueue nameNodes;
        ...
        {
            private readonly XamlNodeQueue attributeNodes;
            private readonly BuilderClassNode classNode;
        ...
        {
            private List<KeyValuePair<string, XamlNodeQueue>> defaultValueNodes;
            private readonly XamlNodeQueue propertiesNodes;
            private readonly BuilderClassNode classNode;
        ...
        {
            private readonly PropertiesNode properties;
        ...
        private class PropertyValueNode : BuilderXamlNode
        {
            ...
            private readonly XamlNodeQueue valueNodes;
        ...
        {
            private readonly Stack<ObjectFrame> objectStack;
            ...
            {
                private XamlWriter parentWriter;
                private XamlNodeQueue currentMemberNodes;
        ...
        {
            private readonly XamlNodeQueue untransformedNodes; // nodes that couldn't be transformed to PropertyReference form
            private readonly XamlMember originalStartMember;
        ...
        {
            private readonly XamlNodeQueue propertyReferenceNodes;
            private PropertyReferencesNode parent;
