...
namespace System.Activities.Runtime.DurableInstancing
{
    ...
    internal abstract class TransactedAsyncResult : AsyncResult
    {
        ...
        private class TransactionSignalScope : SignalGate<IAsyncResult>, IDisposable
        {
            ...
            private readonly TransactedAsyncResult parent;
            ...
            void IDisposable.Dispose()
            {
                ...
                catch (Exception exception)
                {
                    ...
                    throw Fx.Exception.AsError(new InvalidOperationException(SR.AsyncTransactionException));
                }
