...
namespace TestCases.Activities
{
    public class Assignment : IDisposable
    {
        ...
        /// <summary>
        /// Simple assignment Assign to a null object
        /// </summary>
        [Fact]
        ...
        /// <summary>
        /// Assign to collections Assign to data types like lists, dictionaries…etc
        /// </summary>
        [Fact]
        ...
        /// <summary>
        /// Simple assignment Assignment activity to and from is not set
        /// </summary>
        [Fact]
        ...
        // TestCustomActivity<InvokeFunc<string, string>> invokeFunc =
        // TestCustomActivity<InvokeFunc<string, string>>.CreateFromProduct( new InvokeFunc<string,
        // string> { Argument = "PassedInValue", Func = new ActivityFunc<string, string> { Argument
        // = delegateInArgument, Result = delegateOutArgument, Handler = new
        // System.Activities.Statements.Sequence { DisplayName = "sequence1", Activities = { new
        // System.Activities.Statements.WriteLine { Text =
        // ExpressionServices.Convert<string>(ctx=>delegateInArgument.Get(ctx)) , DisplayName =
        // "W1"}, new System.Activities.Statements.Assign<string> { DisplayName = "Assign1", To =
        // delegateInArgument, Value = new VisualBasicValue<string>("Input & \"_VB\"") , }, new
        // System.Activities.Statements.WriteLine { Text =
        // ExpressionServices.Convert<string>(ctx=>delegateInArgument.Get(ctx)) , DisplayName =
        // "W2"}, new System.Activities.Statements.Assign<string> { DisplayName = "Assign2", To =
        // delegateOutArgument, Value = delegateInArgument, }, }, } } } );

        // TestSequence sequenceForTracing = new TestSequence { DisplayName = "sequence1",
        // Activities = { new TestSequence{ DisplayName = "W1"}, new TestAssign<string>("Assign1"),
        // new TestSequence{ DisplayName = "W2"}, new TestAssign<string>("Assign2"), } }; invokeFunc.CustomActivityTraces.Add(sequenceForTracing.GetExpectedTrace().Trace);

        // TestWriteLine root = new TestWriteLine { HintMessage = "PassedInValue_VB",
